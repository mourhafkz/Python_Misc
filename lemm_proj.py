...
lemmas_dict = [['not', 'nt', 'nott', 'n0t', 'nawt', 'nottt', 'nto', 'notttt', 'noot', 'nooot', 'not-', 'noooot', 'nottttt', '_not_', 'naht', "n't", 'nnot', 'nooooot', 'notttttt', '-not-', 'noit', '/not/', 'noooooot', 'nottttttt', 'noht'],
               ['been', 'beeen', 'beeeen', 'beenn', 'beeeeen', 'beeeeeen', 'b33n'], ['just', 'jus', 'juss', 'jst', 'juz', 'jsut', 'jux', 'justt', 'jut', 'just', 'jz', 'jusst', 'jusss', 'jss', '#just', 'jusz', 'juat', 'juust', 'jusy', 'juts', 'juuust', 'jusr', 'justed', 'juzt', 'justtt', 'jjust', 'juuuust', 'juhs', 'juzz', 'jzt', 'juxx', 'jusx', 'jussst', 'justs', 'jhuss', 'jussss', 'jhus', 'kust', 'juuuuust', 'jsst', 'juus', 'ju$t', 'jusssst', 'justttt', 'jyst'],
